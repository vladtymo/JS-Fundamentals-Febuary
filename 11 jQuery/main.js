...
$list.children().each(function (ind, el) {
...
console.log('Text:', item.text()); // textContent
console.log('HTML:', item.html()); // innerHTML
// console.log('Text:', item.text("New text content!")); // set text content
